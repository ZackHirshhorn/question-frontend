...
// Server template after sanitizeTemplate(): questions are arrays of string IDs
...
/**
 * @deprecated this function is not necessary anymore, the server expects ids just like it sends.
 * 
